    ...
    void testLuceneHeadersMigrationJava() {
        ...
        rewriteRun(
                mavenProject("test-lucene",
                        pomXml(CamelTestUtil.pomXmlWithDependency("camel-lucene", CamelTestUtil.getCamelLatestVersion())),
                        java(
                        """
    ...
    void testJGroupsHeadersMigration() {
        ...
        rewriteRun(
                mavenProject("test-jgroups",
                        pomXml(CamelTestUtil.pomXmlWithDependency("camel-jgroups", CamelTestUtil.getCamelLatestVersion())),
                        java(
                        """
                        import org.apache.camel.Exchange;
                        import org.apache.camel.builder.RouteBuilder;
    ...
    void testJGroupsRaftHeadersMigration() {
        ...
        rewriteRun(
                mavenProject("test-jgroups-raft",
                        pomXml(CamelTestUtil.pomXmlWithDependency("camel-jgroups-raft", CamelTestUtil.getCamelLatestVersion())),
                        java(
                        """
                        import org.apache.camel.Exchange;
                        import org.apache.camel.builder.RouteBuilder;
    ...
    void testShiroHeadersMigration() {
        ...
        rewriteRun(
                mavenProject("test-shiro",
                        pomXml(CamelTestUtil.pomXmlWithDependency("camel-shiro", CamelTestUtil.getCamelLatestVersion())),
                        java(
                        """
                        import org.apache.camel.Exchange;
                        import org.apache.camel.builder.RouteBuilder;
    ...
    void testSolrHeadersMigration() {
        ...
        rewriteRun(
                mavenProject("test-solr",
                        pomXml(CamelTestUtil.pomXmlWithDependency("camel-solr", CamelTestUtil.getCamelLatestVersion())),
                        java(
                        """
                        import org.apache.camel.Exchange;
                        import org.apache.camel.builder.RouteBuilder;
    ...
    void testGoogleCloudHeadersMigrationJava() {
        ...
        rewriteRun(
                mavenProject("test-google-cloud",
                        pomXml(CamelTestUtil.pomXmlWithDependency("camel-google-functions", CamelTestUtil.getCamelLatestVersion())),
                        java(
                        """
                        import org.apache.camel.Exchange;
                        import org.apache.camel.builder.RouteBuilder;
    ...
    void testMongoDbGridFsHeadersMigrationJava() {
        ...
        rewriteRun(
                mavenProject("test-mongodb",
                        pomXml(CamelTestUtil.pomXmlWithDependency("camel-mongodb-gridfs", CamelTestUtil.getCamelLatestVersion())),
                        java(
                        """
                        import org.apache.camel.Exchange;
                        import org.apache.camel.builder.RouteBuilder;
    ...
    void testOpenstackHeadersMigrationJava() {
        ...
        rewriteRun(
                mavenProject("test-openstack",
                        pomXml(CamelTestUtil.pomXmlWithDependency("camel-openstack", CamelTestUtil.getCamelLatestVersion())),
                        java(
                                """
                                import org.apache.camel.Exchange;
                                import org.apache.camel.builder.RouteBuilder;
    ...
    void testWeb3jHeadersMigrationJava() {
        ...
        rewriteRun(
                mavenProject("test-web3j",
                        pomXml(CamelTestUtil.pomXmlWithDependency("camel-web3j", CamelTestUtil.getCamelLatestVersion())),
                        java(
                                """
                                import org.apache.camel.Exchange;
                                import org.apache.camel.builder.RouteBuilder;
